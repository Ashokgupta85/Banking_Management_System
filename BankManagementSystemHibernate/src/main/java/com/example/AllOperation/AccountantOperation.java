package com.example.AllOperation;
				...
				while (y) {
					...
					if (x == 1) {
						...
						try {
					        ...
					        try {
					            as.addAccount(balance, customerId); // Add account with the provided opening balance and customer Id
					            System.out.println("-----------------------------------------------------------------");
					            System.out.println("  Customer Account Added Successfully..!!!"); // Inform user about successful account addition
					            System.out.println();
					        ...
					        System.out.println("-----------------------------------------------------------------");
					        System.out.println("  Invalid Input ...Please Try Again !!" + e.getMessage()); // Inform user about invalid input
					        System.out.println();
					    }
					        ...
					        try {
					            ...
					            if (result != null) {
					               ...
					               // Extract account balance
					                ...
					                System.out.println("  First Name : " + user.getFirstName() + " " + user.getLastName());
					    ...
					    try {
					        ...
					        try {
					            ...
					            for (Object[] customerDetails : customerDetailsList) {
					                ...
					                System.out.println("  Customer Name : " + user.getFirstName() + " " + user.getLastName());
